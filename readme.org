...
/This is my customized Miryoku layout with the only adjustment being Inverted-T and ignoring the "mouse" keys in Keyboard Layout Editor since they don't work with ZMK/BT anyway./
